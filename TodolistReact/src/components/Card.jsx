...
function Card({title="default",about="Some priority", priority = "low"}) {
  return (
    <div className='border-2 rounded-md shadow-md shadow-cyan-800 py-5 px-5 flex flex-col gap-4 bg-gray-300'>
            ...
            <div className='flex gap-5'>
                <button className='cursor-pointer'><FiEdit size={20} /></button>
                <button className='cursor-pointer'><MdOutlineDelete size={20} /></button>
            </div>
        </div>
  )
}
